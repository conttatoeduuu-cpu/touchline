...
/* oxlint-disable jsx-a11y/prefer-tag-over-role, jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- The addon delegates focus to its associated input; making it a button would create invalid nested controls. */
